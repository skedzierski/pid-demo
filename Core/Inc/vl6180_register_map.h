#ifndef VL1680_REG_MAP_H_
#define VL1680_REG_MAP_H_
...
#define IDENTIFICATION__TIME 0x008 // 2 bytes
...
#define SYSRANGE__CROSSTALK_COMPENSATION_RATE 0x01E // 2 bytes
#define SYSRANGE__CROSSTALK_VALID_HEIGHT 0x021  
#define SYSRANGE__EARLY_CONVERGENCE_ESTIMATE 0x022  // 2 bytes
#define SYSRANGE__PART_TO_PART_RANGE_OFFSET 0x024  
#define SYSRANGE__RANGE_IGNORE_VALID_HEIGHT 0x025  
#define SYSRANGE__RANGE_IGNORE_THRESHOLD 0x026  // 2 bytes
...
#define RESULT__HISTORY_BUFFER_x 0x052 // 2 bytes 
#define RESULT__RANGE_VAL 0x062 
#define RESULT__RANGE_RAW 0x062 
#define RESULT__RANGE_RETURN_RATE 0x066 // 2 bytes
#define RESULT__RANGE_REFERENCE_RATE 0x068 // 2 bytes
#define RESULT__RANGE_RETURN_SIGNAL_COUNT 0x06C // 4 bytes
...
#define RESULT__RANGE_RETURN_CONV_TIME 0x07C // 4 bytes
#define RESULT__RANGE_REFERENCE_CONV_TIME 0x080 // 4 bytes
